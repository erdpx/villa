    ...
    def error(self) -> torch.Tensor:
        ...
        for b in range(batch_size):
            ...
            if 0 <= y < h-1 and 0 <= x < w-1:
                ...
                # Extract z-coordinate (1st element, index 0) in ZYX order
                z = p[0]
    ...
    def jacobians(self) -> Tuple[List[torch.Tensor], torch.Tensor]:
        ...
        for b in range(batch_size):
            ...
            if 0 <= y < h-1 and 0 <= x < w-1:
                ...
                # Using index 0 for Z in ZYX coordinate order
                c00 = matrix_tensor[b, yi, xi, 0]        # top-left
                c01 = matrix_tensor[b, yi, xi+1, 0]      # top-right
                c10 = matrix_tensor[b, yi+1, xi, 0]      # bottom-left
                c11 = matrix_tensor[b, yi+1, xi+1, 0]    # bottom-right
